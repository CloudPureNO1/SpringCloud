package com.wxm.nacos.sentinel.gateway.handler;
...
public class MyBlockRequestHandler implements BlockRequestHandler {
    ...
    public Mono<ServerResponse> handleRequest(ServerWebExchange exchange, Throwable ex) {
        ...
        // 返回http状态码为200
        return ServerResponse.status(200).contentType(MediaType.APPLICATION_JSON_UTF8).body(BodyInserters.fromObject(buildErrorResult(ex)));
    }
